...
SHELLBUTTON1_CLOSE="$curdir/../sbin/smb-action.sh serverstop"
SHELLBUTTON1_OPEN="$curdir/../sbin/smb-action.sh serverstart"
SHELLBUTTON2="$curdir/../sbin/smb-action.sh config"
SHELLBUTTON3="$curdir/../sbin/smb-action.sh flush"
SHELLBUTTON4="$curdir/../sbin/smb-action.sh next"
SHELLBUTTON5="$curdir/../sbin/smb-action.sh openmd"
SHELLBUTTON6="$curdir/../sbin/smb-action.sh passwd"
HEAD='"cmd":"'
TAIL='",'
